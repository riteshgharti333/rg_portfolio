            ...
            <div className="relative border border-[var(--border)] bg-[var(--background)] hover:border-[var(--primary)] transition-all duration-300">
              ...
              <div className="p-6 md:p-8">
                <p className="text-sm leading-relaxed text-[var(--muted-foreground)]">
                  ...
                  scalable, and production-ready web applications. I specialize
                  in{" "}
                ...
                <p className="mt-4 text-sm leading-relaxed text-[var(--foreground)]">
                  ...
                  transforming complex ideas into clean, intuitive products with
                  maintainable architecture and attention to performance.
                </p>
              </div>
            </div>
