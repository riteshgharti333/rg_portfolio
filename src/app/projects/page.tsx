...
const Projects = () => {
  return (
    <>
      <SEO
        title="Projects | Ritesh Gharti"
        description="Explore the professional projects of Ritesh Gharti, featuring modern software applications, web platforms, and digital products."
        canonical="https://ritesh-gharti-portfolio.vercel.app/projects"
      />
