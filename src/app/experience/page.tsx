...
const Experience = () => {
  ...
  return (
    <>
      <SEO
        title="Experience | Ritesh Gharti"
        description="Explore the professional experience of Ritesh Gharti, a Full Stack Developer specializing in modern web applications, React, Next.js, TypeScript, Node.js, and scalable software development."
        canonical="https://ritesh-gharti-portfolio.vercel.app/experience"
      />
      <section
        ref={sectionRef}
        id="experience"
